...
central_plot <- ggplot(data = data.frame(central_obs), aes(x = central_obs))
```
...
noncentral_plot <- ggplot(data = data.frame(noncentral_obs), aes(x = noncentral_obs)) 
```
...
noncentral_plot <- noncentral_plot + 
```
